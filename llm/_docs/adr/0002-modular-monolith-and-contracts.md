...
- Contract changes предшествуют реализации, а сгенерированные клиенты обновляются и проверяются вместе с
  OpenAPI/AsyncAPI. Ручные копии transport DTO не считаются контрактом.
